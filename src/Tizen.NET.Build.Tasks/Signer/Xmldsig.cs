...
namespace Tizen.NET.Build.Tasks.Signer
{
    ...
    public class XmldsigForWidgetDigSig
    {
        ...
        public const string SignatureMethodURI = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha256";
        public const string DigestMethodURI = "http://www.w3.org/2001/04/xmlenc#sha256";
        ...
        public SHA256WithRSA Signer { get; private set; }
        ...
        private string GenerateSignedXML()
        {
            ...
            string signedInfoHash = GetRSA_SHA256(signedInfo);
        ...
        private string GetRSA_SHA256(XElement el)
        {
